...
#     extraction_token = emb[0]
#     prefix = tokenizer(f"{name}\n", return_tensors="pt").input_ids.to(device)
#     prefix = embeddings(prefix)
#     prefix = torch.cat([extraction_token, prefix], dim=1)
...
#         "straight_pwd_logprob": pwd_logprob,
#         "straight_incorrect_logprob": incorrect_logprob,
#         "emb_pwd_logprob": emb_pwd_logprob,
#         "emb_incorrect_logprob": emb_incorrect
#     }
